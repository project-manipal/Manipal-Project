  ...
  return (
    <div className="footer-main-split" style={{ display: 'flex', width: '100vw', height: '100vh' }}>
      ...
      >
        ...
        >
          <h2 className="let-there-be-care-c" style={{ textAlign: 'center', width: '100%' }}>Let there be care</h2>

          {/* SINGLE OUTER BOX FOR BOTH COLUMNS */}
          <div className="footer-box-wrapper">
            <div className="footer-columns">
              <div className="footer-col">
                <a href="/appoitment-inf">Appointment Info</a>
          ...
          <div className="footer-copy-center-c" style={{ textAlign: 'left', width: '100%', marginTop: 48 }}>
